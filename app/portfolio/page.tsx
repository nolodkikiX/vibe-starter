      ...
      <section className="section portfolio-proof-layout">
        <article className="portfolio-proof-main glass-card image-proof-card">
          ...
          <div className="proof-copy">
            ...
            <p>
              Здесь должен жить крупный проект или серия, после которой клиент сразу понимает уровень кадра,
              света и общей режиссуры визуала. Это не просто сетка картинок, а главный аргумент в пользу студии.
            </p>
          </div>
        </article>
